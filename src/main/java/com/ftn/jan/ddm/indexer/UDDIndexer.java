...
import com.ftn.jan.ddm.indexer.handler.DocumentHandler;
...
//	}
	...
	public void index(File folder, EbookViewModel ebook) {
		// TODO Auto-generated method stub
		try {
			openIndexWriter();
			if(folder.isDirectory()){
	...
	private void fileIndexer(File file, EbookViewModel ebook) {
		// TODO Auto-generated method stub
		DocumentHandler handler;
		handler = getHandler(file);
		if(handler != null){
	...
	private void folderIndexer(File folder, EbookViewModel ebook) {
		// TODO Auto-generated method stub
		if(!folder.isDirectory()) return;
		File[] files = folder.listFiles();
